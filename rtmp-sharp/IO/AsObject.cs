...
namespace RtmpSharp.IO
{
    ...
    {
        private readonly Dictionary<string, object> underlying;
        ...
        {
            get { return ((IDictionary<string, object>) underlying).IsReadOnly; }
        }
    ...
    public class AsObjectConverter : TypeConverter
    {
        ...
        {
            if (destinationType.IsValueType || destinationType.IsEnum || destinationType.IsArray ||
                destinationType.IsAbstract || destinationType.IsInterface)
                return false;
            return true;
        }
