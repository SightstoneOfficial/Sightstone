...
namespace Complete
{
    ...
    internal static class MethodFactory
    {
        ...
        private static readonly ConcurrentDictionary<object, ConstructorCall> ConstructorCache =
            new ConcurrentDictionary<object, ConstructorCall>();

        private static readonly ConcurrentDictionary<object, MethodCall> MethodCache =
            new ConcurrentDictionary<object, MethodCall>();

        private static ExpressionArgsPair GetObjectCreatorExpressions(ConstructorInfo constructor)
        {
        ...
        private static ExpressionArgsPair GetMethodCallExpressions(MethodInfo method)
        {
            // create a single param of type object[]
