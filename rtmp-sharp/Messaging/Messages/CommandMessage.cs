...
namespace RtmpSharp.Messaging.Messages
{
    public enum CommandOperation
    {
        ...
        ClientSync = 4,
        // sent by remote to sync missed or cached messages to a client as a result of a client issued poll command
        ClientPing = 5, // connectivity test
        DataUpdate = 7,
        ClusterRequest = 7,
        // request a list of failover endpoint URIs for the remote destination based on cluster membership
        Login = 8,
        Logout = 9,
