...
namespace RtmpSharp.Net
{
    ...
    internal class RtmpPacketWriter
    {
        ...
        private readonly AutoResetEvent packetAvailableEvent;
        private readonly ConcurrentQueue<RtmpPacket> queuedPackets;
        private readonly Dictionary<int, RtmpHeader> rtmpHeaders;
        private readonly Dictionary<int, RtmpPacket> rtmpPackets;
        private readonly AmfWriter writer;
        private int writeChunkSize = DefaultChunkSize;
        ...
        public void WriteLoop()
        {
            ...
            {
#if DEBUG
                Debug.Print("Exception: {0} at {1}", ex, ex.StackTrace);
                if (ex.InnerException != null)
                {
                    var inner = ex.InnerException;
                    Debug.Print("InnerException: {0} at {1}", inner, inner.StackTrace);
                }
#endif
        ...
        {
            if (previousHeader == null || header.MessageStreamId != previousHeader.MessageStreamId ||
