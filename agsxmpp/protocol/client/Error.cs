...
namespace agsXMPP.protocol.client
{
    ...
    public class Error : Element
    {
        ...
        public string ErrorText
        {
            ...
            set { SetTag("text", value, Uri.STANZAS); }
        }
        ...
        public ErrorCondition Condition
        {
            get
            {
                ...
                if (HasTag("conflict")) // <conflict/> 
                    return ErrorCondition.Conflict;
                if (HasTag("feature-not-implemented")) // <feature-not-implemented/>
                    return ErrorCondition.FeatureNotImplemented;
                if (HasTag("forbidden")) // <forbidden/> 
                    return ErrorCondition.Forbidden;
                if (HasTag("gone")) // <gone/>
                    return ErrorCondition.Gone;
                if (HasTag("internal-server-error")) // <internal-server-error/>
                    return ErrorCondition.InternalServerError;
                if (HasTag("item-not-found")) // <item-not-found/> 
                    return ErrorCondition.ItemNotFound;
                if (HasTag("jid-malformed")) // <jid-malformed/>
                    return ErrorCondition.JidMalformed;
                if (HasTag("not-acceptable")) // <not-acceptable/> 
                    return ErrorCondition.NotAcceptable;
                if (HasTag("not-allowed")) // <not-allowed/>
                    return ErrorCondition.NotAllowed;
                if (HasTag("not-authorized")) // <not-authorized/>
                    return ErrorCondition.NotAuthorized;
                if (HasTag("not-modified")) // <not-modified/>
                    return ErrorCondition.NotModified;
                if (HasTag("payment-required")) // <payment-required/>
                    return ErrorCondition.PaymentRequired;
                if (HasTag("recipient-unavailable")) // <recipient-unavailable/>
                    return ErrorCondition.RecipientUnavailable;
                if (HasTag("redirect")) // <redirect/>
                    return ErrorCondition.Redirect;
                if (HasTag("registration-required")) // <registration-required/>
                    return ErrorCondition.RegistrationRequired;
                if (HasTag("remote-server-not-found")) // <remote-server-not-found/> 
                    return ErrorCondition.RemoteServerNotFound;
                if (HasTag("remote-server-timeout")) // <remote-server-timeout/> 
                    return ErrorCondition.RemoteServerTimeout;
                if (HasTag("resource-constraint")) // <resource-constraint/>
                    return ErrorCondition.ResourceConstraint;
                if (HasTag("service-unavailable")) // <service-unavailable/> 
                    return ErrorCondition.ServiceUnavailable;
                if (HasTag("subscription-required")) // <subscription-required/> 
                    return ErrorCondition.SubscriptionRequired;
                if (HasTag("undefined-condition")) // <undefined-condition/> 
                    return ErrorCondition.UndefinedCondition;
                if (HasTag("unexpected-request")) // <unexpected-request/> 
