...
namespace agsXMPP.protocol.extensions.si
{
    ...
    public class SI : Element
    {
        ...
        ///     This SHOULD NOT be sent back on type='result', since the &lt;iq/&gt; "id" attribute provides the only context
        ///     needed.
        ///     This value is generated by the Sender, and the same value MUST be used throughout a session when talking to the
        ///     Receiver.
        /// </summary>
        public string Id
        {
