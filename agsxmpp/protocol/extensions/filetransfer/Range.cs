...
namespace agsXMPP.protocol.extensions.filetransfer
{
    ...
    ///     When no range element is sent in the Stream Initiation result, the Sender MUST send the complete file starting at
    ///     offset 0.
    ///     More generally, data is sent over the stream byte for byte starting at the offset position for the length
    ///     specified.
    /// </summary>
