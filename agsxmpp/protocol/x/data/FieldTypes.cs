...
namespace agsXMPP.protocol.x.data
{
    ...
    public enum FieldType
    {
        ...
        /// <summary>
        ///     The field enables an entity to gather or provide an either-or choice between two options. The allowable values are
        ///     1 for yes/true/assent and 0 for no/false/decline. The default value is 0.
        /// </summary>
        Boolean,

        /// <summary>
        ///     The field is intended for data description (e.g., human-readable text such as "section" headers) rather than data
        ///     gathering or provision. The
        ///     <value />
        ///     child SHOULD NOT contain newlines (the \n and \r characters); instead an application SHOULD generate multiple fixed
        ///     fields, each with one
        ///     <value />
        ///     child.
        /// </summary>
        Fixed,
        ...
        ///     The field enables an entity to gather or provide a single line or word of text, which shall be obscured in an
        ///     interface (e.g., *****).
        /// </summary>
        Text_Private,
        ...
        ///     This field type is the default and MUST be assumed if an entity receives a field type it does not understand.
        /// </summary>
        Text_Single
    }
}