...
namespace agsXMPP
{
...

    {
        ...
        */
        ...
        /// <summary>
        ///     Create a new JID object from a string. The input string must be a valid jabberId and already prepared with
        ///     stringprep.
        ...
        public bool Parse(string fullJid)
        {
            ...
            try
            {
                ...
                var atPos = m_Jid.IndexOf('@');
                var slashPos = m_Jid.IndexOf('/');
