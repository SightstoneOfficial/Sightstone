...
namespace agsXMPP.Xml.Dom
{
    public class Element : Node
    {
        ...
        public int GetAttributeInt(string name)
        {
            if (HasAttribute(name))
            {
                return int.Parse((string) Attributes[name]);
            }
            return 0;
        }
        ...
        public long GetAttributeLong(string name)
        {
            if (HasAttribute(name))
            {
                return long.Parse((string) Attributes[name]);
            }
            return 0;
        }
        ...
        public bool GetAttributeBool(string name)
        {
            if (HasAttribute(name))
            {
                var tmp = (string) Attributes[name];
                if (tmp.ToLower() == "true")
                    return true;
                return false;
            }
        ...
        public double GetAttributeDouble(string name, IFormatProvider ifp)
        {
            if (HasAttribute(name))
            {
                try
                {
                    return double.Parse((string) Attributes[name], ifp);
                }
                catch
                {
                    return double.NaN;
        ...
        {
            var tag = _SelectElement(this, TagName);
            if (tag != null)
                return tag.Value;
            return null;
        }
        ...
        {
            var tag = _SelectElement(this, TagName, traverseChildren);
            if (tag != null)
                return tag.Value;
            return null;
        }
        ...
        {
            var tag = _SelectElement(this, type);
            if (tag != null)
                return tag.Value;
            return null;
        }
        ...
        {
            var b = Convert.FromBase64String(GetTag(TagName));
            return Encoding.ASCII.GetString(b, 0, b.Length);
        }
        ...
        {
            var b = Encoding.Unicode.GetBytes(argText);
        ...
        public void SetTag(string argTagname, string argText, string argNS)
        {
            ...
            {
                var e = SelectSingleElement(argTagname);
                e.Value = argText;
                e.Namespace = argNS;
            }
        }
        ...
        {
            var tag = _SelectElement(this, name);
            if (tag != null)
                return true;
            return false;
        }
        ...
        {
            var tag = _SelectElement(this, name, traverseChildren);
            if (tag != null)
                return true;
            return false;
        }
        ...
        {
            var tag = _SelectElement(this, type, traverseChildren);
            if (tag != null)
                return true;
            return false;
        }
        ...
        public void SetAttribute(string name, bool val)
        {
            ...
            Attributes.Add(name, val ? "true" : "false");
        }
